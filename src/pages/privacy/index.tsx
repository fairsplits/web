...
export const PrivacyPage = (): ReactElement => {
  return (
    <div className="prose px-52 py-12">
      ...
      <br />
      <p>
        These terms and conditions apply to the Fairsplits app (hereby referred to as "Application")
        for mobile devices that was created by Fairsplits (hereby referred to as "Service Provider")
        as a Free service.
      </p>
      <br />
      <p>
      ...
      <br />
      <p>These terms and conditions are effective as of 2025-05-08</p>
      <br />
      <strong>Contact Us</strong>
      <p>
        If you have any questions or suggestions about the Terms and Conditions, please do not
        hesitate to contact the Service Provider at support@fairsplits.in.
      </p>
      <hr />
    </div>
  );
